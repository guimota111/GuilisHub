...
const SECTIONS = [
  {
    ...
    sites: [
      ...
      },
      {
        icon: "🧠",
        title: "BrainPath",
        desc: "Quadros de estudo em árvore, com notas, flashcards, checklists, tabelas e gráficos num canvas interligado.",
        url: "https://brainpath123.web.app/",
        tag: "Estudos",
        accent: "#818cf8",
      },
      {
        icon: "🔤",
        title: "GU Macros",
        desc: "Busca rápida das siglas de patologia geniturinária, bilíngue, com o código pronto para colar no laudo.",
      ...
      },
      {
        ...
        desc: "Organiza os scripts do Tampermonkey por categoria, com histórico de versões e changelog de cada mudança.",
...

  {
    ...
    sites: [
      ...
      },
      {
        icon: "🦌",
        title: "ChopperMoney",
        desc: "Acompanhamento do patrimônio do casal: renda fixa, renda variável, dividendos, reserva de emergência e projeções.",
